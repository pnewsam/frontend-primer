...
## Stage 1 — Core Form and Client Validation (Foundational)
...
## Stage 2 — Async Username Availability (Intermediate)
...
## Stage 3 — Submission Flow and Resilience (Advanced)
...
## Stage 4 — Architecture, Accessibility, and UX Polish (Senior)
...
## Stage 5 — Reflection and Testing Strategy (Meta)
